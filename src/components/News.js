...
export class News extends Component {
    ...
    constructor(props) {
        ...
        document.title = `${this.capitalizeFirstLetter(this.props.category)} - NewsJunkey`;
    }
    ...
    render() {
        return (
            <>
                <h1 className="text-center" style={{ margin: '40px 0px' }}>NewsJunkey - Top {this.capitalizeFirstLetter(this.props.category)} headlines !!</h1>
                ...
                {/* <div className="container d-flex justify-content-between">
                    <button disabled={this.state.page <= 1} type="button" onClick={this.handlePrev} className="btn btn-dark my-2">&#8592;Previous</button>
                    <button disabled={this.state.page + 1 > Math.ceil(this.state.totalResults / this.props.pageSize)} type="button" onClick={this.handleNext} className="btn btn-dark my-2">Next&#8594;</button>
                </div> */}
            </>
        );
    }
